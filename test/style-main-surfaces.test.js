...
// VIN-68 — Light mode: main area, terminal search bar, session grid, Plans,
// Memory and the markdown preview.
//
// A per-surface migration lot (sibling of VIN-67): the hard-written colours in
// these sections move onto the token layer so the grid view, Plans, Memory and
// markdown rendering stay legible in light mode and coherent in dark. The
...
// color-mix() over them, never a literal hex / rgb() / hsl().
