...
The workspace also carries pre-existing type labels — `Bug`, `Feature`, `Improvement`,
`Security` — which are orthogonal to triage state and can be combined with the above.
