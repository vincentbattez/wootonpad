...
import { areas } from './stores/areas.js';
import { layout } from './stores/layout.js';
import { header } from './stores/header.js';
import { avatars } from './stores/avatars.js';
...
// value (so a component reading `store.activeTab` tracks `layout.activeTab`),
...
export const slices = { sessions, sidebar, areas, layout, header, avatars };
...
export { sessions, sidebar, areas, layout, header, avatars };
