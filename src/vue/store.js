...
export const slices = { sessionsStore, settingsStore, sidebarStore, areasStore, layoutStore, headerStore, avatarsStore };
...
export { sessionsStore, settingsStore, sidebarStore, areasStore, layoutStore, headerStore, avatarsStore };
