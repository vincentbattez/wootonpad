...
// renders the panel at `style`; the caller opens it from a click event. The dismissers are
// also dropped when the owning scope dies, so unmounting with the menu open leaks nothing.
